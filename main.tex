...
% Pengaturan halaman kosong
\newcommand{\currentpagestyle}{fancy}
...
\let\customizedcleardoublepage\cleardoublepage
\patchcmd{\customizedcleardoublepage}{\hbox{}}{
  \thispagestyle{\currentpagestyle}
  \vspace*{\fill}
  \begin{center}\textit{[Halaman ini sengaja dikosongkan]}\end{center}
  \vfill}{}{}
\renewcommand{\cleardoublepage}[1][fancy]{
  \renewcommand{\currentpagestyle}{#1}
  \customizedcleardoublepage
}
...
\cleardoublepage
  ...
  % Daftar singkatan
  \input{lainnya/daftar-singkatan.tex}
  \cleardoublepage
...
\input{bab/4-hasil-dan-pembahasan.tex}
\cleardoublepage

% Bab 5 kesimpulan dan saran
\input{bab/5-kesimpulan-dan-saran.tex}
\cleardoublepage

% Lampiran
\input{bab/6-lampiran.tex}
\cleardoublepage
